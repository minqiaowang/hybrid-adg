...
- Prepare On Premise Database(choose LVM)
...
rm /u02/app/oracle/oradata/ORCL_nrt187/PDB1/system01.dbf
rm /u02/app/oracle/oradata/ORCL_nrt187/PDB1/sysaux01.dbf
rm /u02/app/oracle/oradata/ORCL_nrt187/PDB1/undotbs01.dbf
rm /u02/app/oracle/oradata/ORCL_nrt187/PDB1/users01.dbf
rm /u02/app/oracle/oradata/ORCL_nrt187/temp01.dbf
rm /u02/app/oracle/oradata/ORCL_nrt187/pdbseed/temp012020-01-23_14-38-01-789-PM.dbf
rm /u02/app/oracle/oradata/ORCL_nrt187/PDB1/temp01.dbf
rm /u03/app/oracle/oradata/ORCL_nrt187/srl_redo01.log
rm /u03/app/oracle/oradata/ORCL_nrt187/srl_redo02.log
rm /u03/app/oracle/oradata/ORCL_nrt187/srl_redo03.log
rm /u03/app/oracle/oradata/ORCL_nrt187/redo04.log
...
SQL> spool off
...
```
<copy>scp oracle@xxx.xxx.xxx.xxx:/u01/app/oracle/product/19c/dbhome_1/dbs/orapwORCL</copy>
```
...
1. Copy the following command, change the (xxx.xxx.xxx.xxx) to the on-premise host public ip.  change `<standby DB_UNIQUE_NAME>` to the unique name of your standby db.
   ...
   ```
   <copy>
   scp oracle@xxx.xxx.xxx.xxx:/u01/app/oracle/admin/ORCL/wallet/ewallet.p12 /opt/oracle/dcs/commonstore/wallets/tde/<standby DB_UNIQUE_NAME>
...
mkdir: cannot create directory '/u02/app/oracle/oradata/ORCL_nrt187/pdbseed': File exists
[oracle@dbstby ~]$ mkdir /u02/app/oracle/oradata/ORCL_nrt187/orclpdb
[oracle@dbstby ~]$ 
```
...
2. Copy the following command, Replace `ORCL_nrt187` with your standby db unique name.
   ...
   ```
   <copy>
   alter system set db_file_name_convert='/u01/app/oracle/oradata/ORCL','/u02/app/oracle/oradata/ORCL_nrt187' scope=spfile;
   alter system set db_create_online_log_dest_1='/u03/app/oracle/redo/ORCL_NRT187/onlinelog';
   ALTER SYSTEM SET log_file_name_convert='/u01/app/oracle/oradata/ORCL','/u03/app/oracle/redo/ORCL_NRT187/onlinelog' scope=spfile;
...
```
SQL> ALTER SYSTEM SET db_file_name_convert='/u01/app/oracle/oradata/ORCL','/u02/app/oracle/oradata/ORCL_nrt187' scope=spfile;

System altered.
SQL> alter system set db_create_online_log_dest_1='/u03/app/oracle/redo/ORCL_NRT187/onlinelog';

System altered.
SQL> alter system set db_domain='' scope=spfile;

System altered.
SQL> ALTER SYSTEM SET log_file_name_convert='/u01/app/oracle/oradata/ORCL','/u03/app/oracle/redo/ORCL_NRT187/onlinelog' scope=spfile;
...
output file name=/u02/app/oracle/oradata/ORCL_nrt187/control01.ctl
output file name=/u03/app/oracle/fast_recovery_area/ORCL_NRT187/control02.ctl
...
channel ORA_DISK_1: restoring datafile 00001 to /u02/app/oracle/oradata/ORCL_nrt187/system01.dbf
channel ORA_DISK_1: restoring section 1 of 1
channel ORA_DISK_1: restore complete, elapsed time: 00:00:16
channel ORA_DISK_1: starting datafile backup set restore
channel ORA_DISK_1: using network backup set from service ORCL
channel ORA_DISK_1: specifying datafile(s) to restore from backup set
channel ORA_DISK_1: restoring datafile 00003 to /u02/app/oracle/oradata/ORCL_nrt187/sysaux01.dbf
channel ORA_DISK_1: restoring section 1 of 1
channel ORA_DISK_1: restore complete, elapsed time: 00:00:16
channel ORA_DISK_1: starting datafile backup set restore
channel ORA_DISK_1: using network backup set from service ORCL
channel ORA_DISK_1: specifying datafile(s) to restore from backup set
channel ORA_DISK_1: restoring datafile 00004 to /u02/app/oracle/oradata/ORCL_nrt187/undotbs01.dbf
channel ORA_DISK_1: restoring section 1 of 1
channel ORA_DISK_1: restore complete, elapsed time: 00:00:04
channel ORA_DISK_1: starting datafile backup set restore
channel ORA_DISK_1: using network backup set from service ORCL
channel ORA_DISK_1: specifying datafile(s) to restore from backup set
channel ORA_DISK_1: restoring datafile 00005 to /u02/app/oracle/oradata/ORCL_nrt187/pdbseed/system01.dbf
......
......
channel ORA_DISK_1: restoring section 1 of 1
channel ORA_DISK_1: restore complete, elapsed time: 00:00:02
...
2. Run the command in sqlplus as sysdba, this will clear the redo log, ignore the unknown command.
